  ...
  template: `
    ...
    <div class="admin-container">
      ...
      <div class="admin-grid">
        ...
        <a routerLink="/admin/denominacion" class="admin-card card-usco"><div class="ac-icon bg-9"><i class="fas fa-university"></i></div><h4>Denominación</h4><p>Programa, Misión, Visión y Propósito</p></a>
      </div>
    </div>
  `,
  styles: `
    ...
    .bg-4{background:linear-gradient(135deg,#2e7d32,#1b5e20)}.bg-5{background:linear-gradient(135deg,#6a1b9a,#4a148c)}.bg-6{background:linear-gradient(135deg,#00838f,#006064)}.bg-7{background:linear-gradient(135deg,#ad1457,#880e4f)}.bg-8{background:linear-gradient(135deg,#5d4037,#3e2723)}.bg-9{background:linear-gradient(135deg,#1e262b,#37474f)}
