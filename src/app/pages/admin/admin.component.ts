...
@Component({
  ...
  styles: `
    ...
    .bg-4{background:linear-gradient(135deg,#2e7d32,#1b5e20)}.bg-5{background:linear-gradient(135deg,#6a1b9a,#4a148c)}.bg-6{background:linear-gradient(135deg,#00838f,#006064)}
