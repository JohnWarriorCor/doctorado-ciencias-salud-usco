...
export class AdminEgresadosComponent implements OnInit {
  ...
  form: Egresado = this.emptyForm(); selectedFile: File | null = null; previewUrl: string | null = null;
